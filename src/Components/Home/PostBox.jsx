  ...
  const savePostToDb = async (
    ...
    try {
      ...
      const data = await axios.post(
        "https://gossip-server-nf7b5t583-oliulla.vercel.app/usersposts",
        postData
      );
      // console.log(data);
  ...
  return (
    <>
      ...
      <form
        ...
        className="w-full my-2 bg-accent rounded-md px-3 py-3"
      >
        ...
        <div className="py-4 text-base-100 flex justify-between">
          <button className="px-2 py-1 rounded-lg border-[2px] border-primary bg-primary flex items-center w-40 md:w-64">
